  ...
  render() {
    return (
      <div className="container">
        ...
        <RacaSelecionadaContext.Provider value={{raca: this.state.racaSelecionada}}>
          <Raca />
        </RacaSelecionadaContext.Provider>
        <RacasContext.Provider value={{racas: this.state.racas, selecionaRaca: this.selecionaRaca}}>
          <ListaRacas />
